# parameters
ARG REPO_NAME="dt-warehouse-demo"
ARG DESCRIPTION="Autonomous warehouse navigation with duckie obstacle detection"
ARG MAINTAINER="Adem Jerbi (adem.jerbi1@etu.cyu.fr)"
ARG ICON="cube"
# ==================================================>
ARG ARCH
ARG DISTRO=ente
